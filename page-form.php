...
<option value="WY">Wyoming</option>
	  ...
	  <tr  >
  <td ><label for='x-std-referralcode'>How did you hear about us?</label></td><td class='standardInput'><select name='x-std-referralcode' id='x-std-referralcode' onChange='checkReferral(this)' class='standardInput'>
...
<tr  >
  <td ><label for='x-std-referralnote'>Referral note:</label></td>
  <td><input class='standardInput' id='x-std-referralnote' name='x-std-referralnote' value=''  autocomplete='off'></td></tr>
